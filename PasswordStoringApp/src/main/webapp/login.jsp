    ...
    <head>
        <style>
            ...
            div {
                 ...
                 left:0;right:0;top:700px;bottom:0;background-color: cornsilk;background-image:url('img/Pic2.jpeg');background-repeat: no-repeat;
                 background-size: cover;
            ...
            h1 {
                ...
                width:fit-content;display: block;margin-left: 475px;
            } 
            input {
