...
<html>
    <head>
        <style>
            ...
            .dv1 {
                 width: 550px;height:235px;padding:50px;background-color:aqua;
    ...
    <body>
        ...
        <form action="/welcome" method=POST>
                <div class="dv1">
                    ...
                    <label style="color: red;font-weight: bold;">(*Username already taken. Please enter a new username)</label><br><br>
                    <label class="lab1">Password : </label>
                    <input class="inp1" style="margin-left: 25px;" type="text" name="password" placeholder="Enter password"><br><br>
                </div><br><br>
                <div class="dv2"> 
                    ...
                    <input class="inp1" style="margin-left: 30px;" type="text" name="aadhar" placeholder="Yahoo password"><br>
                    <label class="lab1">Pan No : </label>
                    <input class="inp1" style="margin-left: 65px;" type="text" name="pan" placeholder="Yahoo password"><br>
